...
namespace DataStructures.Trees
{
    public static class TreeDrawer
    {
        ...
        public static string DrawTree<TKey, TValue>(this IBinarySearchTree<TKey, TValue> tree,
            bool includeValues = false) where TKey : IComparable<TKey>
        {
            int position, width;
            ...
            where T : IComparable<T>
        {
            ...
            // Calculate pads
            var middle = Math.Max(Math.Max(2, nodeLabel.Length), rightPosition + leftWidth - leftPosition + 1);
            ...
            if ((middle - nodeLabel.Length%2 == 1) && (nodeLabel.Length < middle) && node.Parent != null &&
                node.IsLeftChild)
                nodeLabel += ".";
            ...
            var listOfLines = new List<string>
            {
                ...
                // 1
                new string(' ', leftPosition) + leftBranch + new string(' ', middle - 2) + rightBranch +
