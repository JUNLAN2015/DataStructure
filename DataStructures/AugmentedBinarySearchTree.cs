...
namespace DataStructures.Trees
{
    ...
    public class BSTRankedNode<T> : BSTNode<T> where T : IComparable<T>
    {
        ...
        public BSTRankedNode(T value, int subtreeSize, BSTRankedNode<T> parent, BSTRankedNode<T> left,
        ...
        // Size of subtrees
        public virtual int SubtreeSize { get; set; }
    ...
    public class AugmentedBinarySearchTree<T> : BinarySearchTree<T> where T : IComparable<T>
    {
        ...
        public override void Remove(T item)
        {
            ...
            var node = (BSTRankedNode<T>) _findNode(Root, item);
